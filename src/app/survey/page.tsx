    ...
    <AppShell>
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "auto", minHeight: 0 }}>
          ...
          {mapExpanded && (
            <button onClick={() => setMapExpanded(e => !e)} style={{ position: "fixed", top: 70, right: 16, zIndex: 99999, background: "#F97316", border: "none", color: "#fff", padding: "8px 16px", borderRadius: 8, cursor: "pointer", fontSize: 13, fontWeight: 700 }}>
              Réduire ⊡
            </button>
          )}
          {view === "map" && (

...
const tutorials = [
  ...
  { id: 11, title: "Gerer les utilisateurs", description: "Gerez les roles et permissions de votre equipe", icon: "👥", color: "#EF4444", steps: ["Allez dans Admin", "Cliquez sur Ajouter utilisateur", "Choisissez le role", "Envoyez l invitation"], href: "/admin" },
  {
    id: 12,
    title: "Chat equipe",
    description: "Communiquez en temps reel avec votre equipe de topographes",
    icon: "💬",
    color: "#22C55E",
    steps: ["Allez dans Chat", "Tapez votre message", "Appuyez sur Entree pour envoyer", "Voyez qui est en ligne", "Supprimez vos messages avec le bouton poubelle"],
    href: "/chat",
  },
  {
    id: 13,
    title: "Planning missions",
    description: "Planifiez et suivez les missions terrain de votre equipe",
    icon: "📅",
    color: "#F97316",
    steps: ["Allez dans Planning", "Cliquez sur un jour du calendrier", "Remplissez le titre et le technicien", "Choisissez une couleur", "Suivez le statut de chaque mission"],
    href: "/planning",
  },
  {
    id: 14,
    title: "Finance et facturation",
    description: "Gerez vos devis, factures et rapport mensuel",
    icon: "💰",
    color: "#F59E0B",
    steps: ["Allez dans Finance", "Creez un devis avec les modeles rapides", "Importez vos tarifs directement", "Generez la facture PDF", "Marquez les factures comme payees", "Exportez le rapport mensuel PDF"],
    href: "/finance",
  },
  {
    id: 15,
    title: "Grille tarifaire",
    description: "Configurez vos tarifs et importez-les dans vos devis",
    icon: "🏷️",
    color: "#A855F7",
